...
/**
 * Repository interface for managing Liability entities in the database. This interface extends
...
public interface LiabilityRepository extends JpaRepository<Liability, Long> {
  /**
   * Finds all liabilities for a specific year and month.
   *
   * @param year The year to search for
   * @param month The month to search for
   * @return List of liabilities for the specified year and month
   */
  List<Liability> findByYearAndMonth(int year, int month);
}
